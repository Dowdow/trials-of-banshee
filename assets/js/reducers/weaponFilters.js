import { SET_WEAPON_FILTERS_DAMAGE_TYPE, SET_WEAPON_FILTERS_QUERY, SET_WEAPON_FILTERS_RARITY, SET_WEAPON_FILTERS_TYPE } from '../actions/weaponFilters';

const init = { damageType: 0, query: '', rarity: 0, type: 0 };
