  ...
  return (
    <section>
      ...
      <div className="flex gap-3 md:gap-10 mt-4 -ml-1">
        <Tooltipable title="collection" description="collection.description" connected={!authenticated}>
          {(ref) => (
            <Link
              ref={ref}
        ...
        <Tooltipable title="triumphs" description="triumphs.description" connected={!authenticated}>
          {(ref) => (
            <Link
              ref={ref}
              to={ROUTES.TRIUMPHS}
