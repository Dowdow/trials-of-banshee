...
export default function GunsmithSeal() {
  ...
  return (
    <div>
      ...
      <button type="button" disabled={!claimable} onClick={handleClick} className={`relative w-full mt-3 border-2 font-bold text-lg tracking-wider ${claimable && 'bg-white/30 border-green-light'} ${completed && 'bg-pink/60 border-pink'} ${!claimable && !completed && 'bg-white/20 border-white/50'}`}>
        {claim && (
          <>
