...
module.exports = {
  ...
  theme: {
    animation: {
      ...
      'engram-decoration-pop': 'engram-decoration-pop 400ms 950ms ease-in-out normal',
      'engram-decoration-pop-next': 'engram-decoration-pop 400ms 1.1s ease-in-out normal',
